...
$(document).ready(function () {
    ...
    events.owlCarousel({
        ...
        navText: ["<i id='left-ole' class='fa fa-chevron-left arrow'></i>", "<i id='right-ole' class='fa fa-chevron-right arrow'></i>"],
        responsive: {
            0: {
                items: 1,
                nav: true,
...
$(document).ready(function () {
    ...
    clients.owlCarousel({
        ...
        dots: false,
        responsiveClass: true,
        navText: ["<i id='left-wcs' class='fa fa-chevron-left arrow'></i>", "<i id='right-wcs' class='fa fa-chevron-right arrow'></i>"],
        responsive: {
            0: {
                items: 1,
                nav: true,
